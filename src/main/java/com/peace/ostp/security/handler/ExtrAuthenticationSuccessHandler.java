package com.peace.ostp.security.handler;
...
public class ExtrAuthenticationSuccessHandler extends AbstractAuthenticationTargetUrlRequestHandler implements AuthenticationSuccessHandler {
     ...
     */
    public ExtrAuthenticationSuccessHandler(String defaultTargetUrl,boolean isPhone) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        String isphone = request.getParameter("j_isphone");
        System.out.println(isphone);
		request.getSession().setAttribute("isphone", isphone);
