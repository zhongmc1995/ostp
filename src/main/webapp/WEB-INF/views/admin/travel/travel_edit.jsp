				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="admin/travel-update" method="post">
								<div class="row">
									<div class="col-sm-4">
										<input type="text" name="travelid" style="display:none" value="${tripTravelInfo.travelid }">
											...
											<div class="col-sm-8">
												...
												<select class="form-control" name="sporttypeid">
													<c:forEach items="${sportType }" var="sportType">
														<c:choose>
															<c:when test="${sportType.SportTypeID eq tripTravelInfo.sporttypeid }">
									...
									<div class="col-sm-4">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<input type="button" class="button" id="add_position" value="选择位置">
											</div>
										</div>
									</div>						
									<div class="col-sm-4">
						                                            ...
						                                            <td> 
						                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
						                                                    <%-- <a  class="blue" href="javascript:void(0);" onclick="add_position(${(statu.index + 1) })"> --%>
						                                                     <a class="blue btn_add" href="javascript:void(0);" attr-id="${(statu.index+1) }">
